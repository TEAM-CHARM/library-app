...
const TestimonialCard = ({ quote, author, role }) => (
  <div className="bg-white p-6 rounded-lg shadow-md">
    <FaQuoteLeft className="text-2xl text-secondary-light mb-4" />
...
const Testimonials = () => {
  ...
  return (
    <section id='testimonial-section' className="bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-secondary-light text-center mb-12">What Our Users Say</h2>
